...
> {
  ...
  componentDidMount(): void {
    ...
    // The current typings for partition are not flexible enough for `pipe()`
    // so we call it directly with the observable.
    // See: https://github.com/nteract/nteract/pull/3691#discussion_r236047782
